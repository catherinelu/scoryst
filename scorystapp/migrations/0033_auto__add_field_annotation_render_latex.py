...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.render_latex'
        db.add_column(u'scorystapp_annotation', 'render_latex',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.render_latex'
        db.delete_column(u'scorystapp_annotation', 'render_latex')
