...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionPage.page_jpeg_small'
        db.add_column(u'scorystapp_submissionpage', 'page_jpeg_small',
                      self.gf('django.db.models.fields.files.ImageField')(default='copy', max_length=100, blank=True),
                      keep_default=False)

        db.start_transaction()
        for submission_page in orm.SubmissionPage.objects.all():
          submission_page.page_jpeg_small = submission_page.page_jpeg
          submission_page.save()
        db.commit_transaction()


    def backwards(self, orm):
        # Deleting field 'SubmissionPage.page_jpeg_small'
        db.delete_column(u'scorystapp_submissionpage', 'page_jpeg_small')
