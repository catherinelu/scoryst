...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FreeformAnnotation'
        db.create_table(u'scorystapp_freeformannotation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission_page', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scorystapp.SubmissionPage'], unique=True)),
            ('annotation_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'scorystapp', ['FreeformAnnotation'])


    def backwards(self, orm):
        # Deleting model 'FreeformAnnotation'
        db.delete_table(u'scorystapp_freeformannotation')
