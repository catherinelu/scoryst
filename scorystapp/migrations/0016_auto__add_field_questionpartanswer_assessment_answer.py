...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionPartAnswer.assessment_answer'
        db.add_column(u'scorystapp_questionpartanswer', 'assessment_answer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='questionpartanswer_assessment_answer', to=orm['scorystapp.AssessmentAnswer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionPartAnswer.assessment_answer'
        db.delete_column(u'scorystapp_questionpartanswer', 'assessment_answer_id')
