...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionPartAnswer.submission'
        db.add_column(u'scorystapp_questionpartanswer', 'submission',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='questionpartanswer_submission', to=orm['scorystapp.Submission']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionPartAnswer.submission'
        db.delete_column(u'scorystapp_questionpartanswer', 'submission_id')
    ...
    models = {
        ...
        u'scorystapp.questionpartanswer': {
            ...
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questionpartanswer_submission'", 'to': u"orm['scorystapp.Submission']"}),
            'custom_points': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'exam_answer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questionpartanswer_exam_answer'", 'to': u"orm['scorystapp.ExamAnswer']"}),
