...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Response.pages'
        db.alter_column(u'scorystapp_response', 'pages', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Response.pages'
        db.alter_column(u'scorystapp_response', 'pages', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=200))
