...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.points'
        db.add_column(u'scorystapp_response', 'points',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Response.graded'
        db.add_column(u'scorystapp_response', 'graded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Submission.points'
        db.add_column(u'scorystapp_submission', 'points',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Submission.graded'
        db.add_column(u'scorystapp_submission', 'graded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.points'
        db.delete_column(u'scorystapp_response', 'points')

        # Deleting field 'Response.graded'
        db.delete_column(u'scorystapp_response', 'graded')

        # Deleting field 'Submission.points'
        db.delete_column(u'scorystapp_submission', 'points')

        # Deleting field 'Submission.graded'
        db.delete_column(u'scorystapp_submission', 'graded')
