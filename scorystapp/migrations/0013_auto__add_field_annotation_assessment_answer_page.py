...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.assessment_answer_page'
        db.add_column(u'scorystapp_annotation', 'assessment_answer_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['scorystapp.AssessmentAnswerPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.assessment_answer_page'
        db.delete_column(u'scorystapp_annotation', 'assessment_answer_page_id')
