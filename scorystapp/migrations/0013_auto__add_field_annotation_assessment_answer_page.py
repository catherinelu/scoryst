...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.submission_page'
        db.add_column(u'scorystapp_annotation', 'submission_page',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['scorystapp.SubmissionPage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.submission_page'
        db.delete_column(u'scorystapp_annotation', 'submission_page_id')
