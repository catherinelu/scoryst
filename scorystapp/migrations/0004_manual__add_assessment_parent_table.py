...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scorystapp_assessment', (
            ...
            ('solutions_pdf1', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
        ...
        for exam in orm.Exam.objects.all():
            ...
            assessment = orm.Assessment(id=exam.id, course1=exam.course, name1=exam.name,
                solutions_pdf1=exam.solutions_pdf, grade_down1=exam.grade_down, cap_score1=exam.cap_score)
            assessment.save()
    ...
    models = {
        ...
        u'scorystapp.assessment': {
            ...
            'solutions_pdf1': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'blank': 'True'})
        },
        u'scorystapp.course': {
