...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SplitPage.is_single'
        db.add_column(u'scorystapp_splitpage', 'is_single',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SplitPage.is_single'
        db.delete_column(u'scorystapp_splitpage', 'is_single')
