...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Homework.hard_deadline'
        db.add_column(u'scorystapp_homework', 'hard_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        db.rename_column('scorystapp_homework', 'submission_deadline', 'soft_deadline')


    def backwards(self, orm):
        # Deleting field 'Homework.hard_deadline'
        db.delete_column(u'scorystapp_homework', 'hard_deadline')
