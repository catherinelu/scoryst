...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'scorystapp_homework', (
            (u'assessment_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scorystapp.Assessment'], unique=True, primary_key=True)),
            ('submission_deadline', self.gf('django.db.models.fields.DateTimeField')()),
            ('solutions_pdf', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'scorystapp', ['Homework'])


    def backwards(self, orm):
        # Deleting model 'Homework'
        db.delete_table(u'scorystapp_homework')
