...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Homework.groups_allowed'
        db.add_column(u'scorystapp_homework', 'groups_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Homework.max_group_size'
        db.add_column(u'scorystapp_homework', 'max_group_size',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding M2M table for field group_members on 'Submission'
        m2m_table_name = db.shorten_name(u'scorystapp_submission_group_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('submission', models.ForeignKey(orm[u'scorystapp.submission'], null=False)),
            ('courseuser', models.ForeignKey(orm[u'scorystapp.courseuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['submission_id', 'courseuser_id'])


    def backwards(self, orm):
        # Deleting field 'Homework.groups_allowed'
        db.delete_column(u'scorystapp_homework', 'groups_allowed')

        # Deleting field 'Homework.max_group_size'
        db.delete_column(u'scorystapp_homework', 'max_group_size')

        # Removing M2M table for field group_members on 'Submission'
        db.delete_table(db.shorten_name(u'scorystapp_submission_group_members'))
    ...
    models = {
        ...
        u'scorystapp.homework': {
            ...
            u'assessment_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['scorystapp.Assessment']", 'unique': 'True', 'primary_key': 'True'}),
            'groups_allowed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hard_deadline': ('django.db.models.fields.DateTimeField', [], {}),
            'max_group_size': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        u'scorystapp.submission': {
            ...
            'graded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'group_members': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'group_members'", 'symmetrical': 'False', 'to': u"orm['scorystapp.CourseUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
