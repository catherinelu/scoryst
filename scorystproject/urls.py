...
urlpatterns = patterns('',
  ...
  url(r'^course/(?P<course_id>\d+)/grade/(?P<exam_id>\d+)/csv/$', 'scorystapp.views.statistics.get_csv_for_exam'),
  ...
  url(r'^course/(?P<course_id>\d+)/(grade|exams/view)/(?P<exam_answer_id>\d+)/question-part/$',
    'scorystapp.views.grade.list_question_parts'),
  url(r'^course/(?P<course_id>\d+)/(grade|exams/view)/(?P<exam_answer_id>\d+)/question-part/(?P<question_part_id>\d+)/answer/$',
    'scorystapp.views.grade.manage_question_part_answer'),
  url(r'^course/(?P<course_id>\d+)/(grade|exams/view)/(?P<exam_answer_id>\d+)/question-part/(?P<question_part_id>\d+)/rubrics/$',
