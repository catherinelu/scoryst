...
urlpatterns = patterns('',
  ...
  url(r'^submit-email/$', 'scorystapp.views.general.submit_email'),
  ...
  url(r'^course/(?P<course_id>\d+)/submit/(?P<course_user_id>\d+)/submissions/$',
      'scorystapp.views.submit.get_submissions'),
  url(r'^course/(?P<course_id>\d+)/submit/submissions/$', 'scorystapp.views.submit.get_self_submissions'),
