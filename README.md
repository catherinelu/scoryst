...
-models.py: All our database models are in this file (UserManager, User, Course, CourseUser, Exam, ExamPage, QuestionPart, Rubric, ExamAnswer, ExamAnswerPage, Response, Annotation). These are well documented within the file.
